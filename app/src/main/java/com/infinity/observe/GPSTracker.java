...
public class GPSTracker extends Service implements LocationListener {
    ...
    private String LOGTAG = "GPSTracker";
    ...
    public void stopUsingGPS() {
        Lazy.dlog(LOGTAG, "stopping GPS usage");
        if (locationManager != null) {
    ...
    public boolean canGetLocation() {
        ...
        Lazy.dlog(LOGTAG, "canGetLocation is returning: " +
                (isGPSEnabled || isNetworkEnabled || (location != null)));
        return isGPSEnabled || isNetworkEnabled || (location != null);
    }
